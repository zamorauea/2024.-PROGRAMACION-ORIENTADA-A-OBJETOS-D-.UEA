...
def mostrar_menu():
    ...
    opciones = {
        '1': 'Tecnicas.POO.py',
        '2': 'Tarea.2.Tecnicas.programación.POO.(Figura.geometrica)..py',
        '3': 'Tarea.3.Comparación de Programción Tradicional y POO EN Paython.py',
        '4': 'Tarea.4.Ejemplo_mundo_real.(Cuenta_Bancaria).py',
        '5': 'Tarea.5.Tipos.Datos.(Libros).py',
        '6': 'Tarea.6.Clase,objetos,herencia,encapsulamiento y polimorfismo.py',
        '7': 'Tarea.7.Implementación.Contructores.y.Destructores.py',
        '8': 'Tarea.8.Deshboard.py'
    }
